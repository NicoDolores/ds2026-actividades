...
botonBuscar.addEventListener("click", function () {
    return __awaiter(this, void 0, void 0, function () {
        var texto, respuesta, datos, libros, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, fetch("https://openlibrary.org/search.json?q=" + texto)];
                case 2:
                    respuesta = _a.sent();
                    return [4 /*yield*/, respuesta.json()];
                case 3:
                    datos = _a.sent();
                    libros = datos.docs.slice(0, 10);
                    libros.forEach(function (libro) {
                        var tarjeta = document.createElement("div");
                        tarjeta.className = "tarjeta";
                        var titulo = "<h3>" + libro.title + "</h3>";
                        var autor = "<p>Autor: " +
                            (libro.author_name
                                ? libro.author_name[0]
                                : "Desconocido")
